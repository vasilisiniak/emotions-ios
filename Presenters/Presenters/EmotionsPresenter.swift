...
private extension EmotionsUseCaseObjects.News {
    var info: String {
        ...
        case .v_1_29_colorDiary: return "Теперь можно включить цветной фон у записей дневника (как было раньше) на вкладке настроек"
        case .v_1_30_hotfix: return "Здравствуйте! Приношу огромнейшие извинения за проблемы с приложением в iOS 17. Мне очень жаль, что так вышло. В этом обновлении исправлена работа приложения на iOS 17. Это быстрый фикс, может быть дёрганый UI и проблемы с виджетом, но я работаю над этим"
        case .v_1_31_widget: return "Исправлена работа виджета в iOS 17 и более ранних версиях iOS"
        case .v_1_33_passcode: return "Теперь можно поставить свой пароль (вместо FaceID/TouchID) для доступа к дневнику"
        }
    }
}
