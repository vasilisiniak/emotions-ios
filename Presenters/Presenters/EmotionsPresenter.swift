...
private extension EmotionsUseCaseObjects.News {
    var info: String {
        ...
        case .v_1_26_save_state: return "Теперь если вы отвлечётесь во время создания записи, то при возвращении в приложение вы вернётесь к незавершённой записи и сможете продолжить с того же места"
        case .v_1_27_edit_emotions: return "Теперь у записей в дневнике можно редактировать эмоции"
        }
    }
}
